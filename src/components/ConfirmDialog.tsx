...
const styles = StyleSheet.create({
  ...
  message: { color: colors.textMuted, fontSize: 14, marginBottom: 20, lineHeight: 20 },
  buttonRow: { flexDirection: 'row', gap: 12 },
  button: { flex: 1, borderRadius: 24, paddingVertical: 12, alignItems: 'center' },
  cancelButton: { borderWidth: 1, borderColor: colors.border, backgroundColor: colors.background },
